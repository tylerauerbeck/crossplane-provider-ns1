...
PROJECT_NAME ?= provider-ns1
PROJECT_REPO ?= github.com/tylerauerbeck/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= ns1-terraform/ns1
export TERRAFORM_PROVIDER_REPO ?= https://github.com/ns1-terraform/terraform-provider-ns1
export TERRAFORM_PROVIDER_VERSION ?= 2.4.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-ns1
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-null_v2.4.1
...
xpkg.build.provider-ns1: do.build.images
